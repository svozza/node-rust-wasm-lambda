...
pub unsafe fn _export_shout_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::shout(_rt::string_lift(bytes0));
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_shout<T: Guest>(arg0: *mut u8) {
    let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(4).cast::<usize>();
    _rt::cabi_dealloc(l0, l1, 1);
}
pub trait Guest {
    fn shout(input: _rt::String) -> _rt::String;
}
#[doc(hidden)]
...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "shout"]
    unsafe extern "C" fn export_shout(arg0: *mut u8,arg1: usize,) -> *mut u8 {
      $($path_to_types)*::_export_shout_cabi::<$ty>(arg0, arg1)
    }
    #[export_name = "cabi_post_shout"]
    unsafe extern "C" fn _post_return_shout(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_shout::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
...
@\x01\x05inputs\0s\x04\0\x05shout\x01\0\x04\x01'component:node-rust-wasm-lambda/\
